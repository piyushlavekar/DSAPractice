...
export const StarIcon = ({ className, isFilled = false }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className} 
    viewBox="0 0 20 20" 
    fill={isFilled ? "currentColor" : "none"} // The magic is here: fill if isFilled is true
    stroke="currentColor" // Always show an outline
  >
...
export const ShuffleIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0L9 5m0 0L7 3m2 2L5 7" />
  </svg>
);
